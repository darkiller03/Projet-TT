...
prepaid_url = base_url + "/particulier/assistance/paiement-recharges" # Changer le lien pour chaque sous-rubrique
...
for offer in offers:
    ...
    try:
        ...
        results.append({
            "URL": full_url,
            "RUBRIQUE": "Assistance", # Changer la rubrique pour chaque rubrique
            "SOUS-RUBRIQUE": "Paiement & Recharges", # Changer la sous-rubrique pour chaque sous-rubrique

...
prepaid_url = base_url + "/particulier/fixe-internet/options-services" # Changer le lien pour chaque sous-rubrique
...
for offer in offers:
    ...
    try:
        ...
        results.append({
            "URL": full_url,
            "RUBRIQUE": "Fixe & Internet", # Changer la rubrique pour chaque rubrique
            "SOUS-RUBRIQUE": "Options & Services", # Changer la sous-rubrique pour chaque sous-rubrique
